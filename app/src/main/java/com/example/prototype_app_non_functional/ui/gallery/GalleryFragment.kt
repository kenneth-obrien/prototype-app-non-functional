package com.example.prototype_app_non_functional.ui.gallery
...
class GalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_dried, container, false)
        return root
    }
    ...
    override fun onViewCreated (view: View, savedInstanceState: Bundle?) {
        ...
        val listView = view.findViewById<TextView>(R.id.dried_list_view) as ListView
